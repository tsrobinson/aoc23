...
- Day 13: catching up a day late, only did part 1. Simple using numpy array indexing. Was going to park part 2 as it looked involved, but realised you can simply ask whether, for any potential axis (as part 1), the configuration across comparison rows/cols differs by at most 1 character. One cool thing I've carried forward is not literally solving the problem: I didn't implement character switching, I just checked whether the condition itself *could* be met.